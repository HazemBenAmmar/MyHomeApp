...
public class HumidityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.hum_fragment_layout, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        node = getArguments() != null ? getArguments().getString("node") : "ttt";
        ...
        valueEventListener = child.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : snapshot.getChildren()) {
                    list.add(Objects.requireNonNull(child.getValue(Values.class)).hum);
    ...
    private void renderData() {
        ...
        xAxis.setValueFormatter((value, axis) -> getDate(Long.parseLong(keys.get((int) value)) * 1000));
